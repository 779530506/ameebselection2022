...
<input type="text" name="numeroCarte" class="form-control" value="{{ $vote->numeroCarte }}" placeholder="numero carte etudiant">
@error('numeroCarte')
...
<div class="form-check">
    <input class="form-check-input" type="radio" {{$vote->president=='amadou' ?'checked':''}}
