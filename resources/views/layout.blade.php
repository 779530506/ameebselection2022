...
<div class = "container" >
 ...
 <div class="container login-container" >
    <div class="row">
                {{-- <h4 class="card-title">Amadou I SARR:
                     {{ $countAmadou }}
                    </h4>
                <h4 class="card-title">Alsane SARR:
                    {{ $countAlsane  }}
                </h4> --}}
                ...
                <form action="{{ route('votes.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="text" name="numeroCarte" class="form-control" placeholder="9945">
                    @error('numeroCarte')
                    ...
                    <div class="form-group">
                        <strong>Tel:</strong>
                        <input type="text" name="telephone" class="form-control" placeholder="779530506">
                        @error('telephone')
                        <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                    </div>
